...
for subj = 1:24
    for sesh = 1:2
        ...
        sat_mask = load_nii(['E:\TDT_MRI\',num2str(subj),'\outputs\ROI\combined\images\',sat_quad,'_prepost.nii']);
        
        sat_vals = load_nii(['E:\TDT_MRI\',num2str(subj),'\outputs\LOCA_contrast\',other_sess{sesh},'\beta_',sat_beta_code,'.nii']);
        ...
        non_sat_mask = load_nii(['E:\TDT_MRI\',num2str(subj),'\outputs\ROI\combined\images\',non_sat_quad,'_prepost.nii']);
        
        non_sat_vals = load_nii(['E:\TDT_MRI\',num2str(subj),'\outputs\LOCA_contrast\',other_sess{sesh},'\beta_',non_sat_beta_code,'.nii']);
...
delta_beta = (betas(:,2) - betas(:,1)) - (betas(:,4) - betas(:,3));
