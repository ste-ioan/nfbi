...
matlabbatch{1}.cfg_basicio.file_dir.file_ops.cfg_named_file.files = {{[homepath,num2str(subject),'\brain\smooth_norm_core-Sub',num2str(subject),'_LOCA1_correct.nii']}};
matlabbatch{2}.cfg_basicio.file_dir.file_ops.cfg_named_file.name = 'pre array';
matlabbatch{2}.cfg_basicio.file_dir.file_ops.cfg_named_file.files = {{[homepath,num2str(subject),'\arrays\spm_array_for_ROI_Baseline.mat']}};
matlabbatch{3}.spm.stats.fmri_spec.dir = {[homepath,num2str(subject),'\outputs\LOCA_contrast\baseline']};
...
matlabbatch{4}.spm.stats.review.print = 'ps';
...
matlabbatch{7}.cfg_basicio.file_dir.file_ops.cfg_named_file.name = 'post brain';
matlabbatch{7}.cfg_basicio.file_dir.file_ops.cfg_named_file.files = {{[homepath,num2str(subject),'\brain\smooth_norm_core-Sub',num2str(subject),'_LOCA2_registered.nii']}};
matlabbatch{8}.cfg_basicio.file_dir.file_ops.cfg_named_file.name = 'post array';
matlabbatch{8}.cfg_basicio.file_dir.file_ops.cfg_named_file.files = {{[homepath,num2str(subject),'\arrays\spm_array_for_ROI_Conclusion.mat']}};
matlabbatch{9}.spm.stats.fmri_spec.dir = {[homepath,num2str(subject),'\outputs\LOCA_contrast\conclusion']};
matlabbatch{9}.spm.stats.fmri_spec.timing.units = 'secs';
matlabbatch{9}.spm.stats.fmri_spec.timing.RT = 1;
matlabbatch{9}.spm.stats.fmri_spec.timing.fmri_t = 16;
matlabbatch{9}.spm.stats.fmri_spec.timing.fmri_t0 = 8;
matlabbatch{9}.spm.stats.fmri_spec.sess.scans(1) = cfg_dep('Named File Selector: post brain(1) - Files', substruct('.','val', '{}',{7}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files', '{}',{1}));
matlabbatch{9}.spm.stats.fmri_spec.sess.cond = struct('name', {}, 'onset', {}, 'duration', {}, 'tmod', {}, 'pmod', {}, 'orth', {});
matlabbatch{9}.spm.stats.fmri_spec.sess.multi(1) = cfg_dep('Named File Selector: post array(1) - Files', substruct('.','val', '{}',{8}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files', '{}',{1}));
...
matlabbatch{9}.spm.stats.fmri_spec.mthresh = thres;
matlabbatch{9}.spm.stats.fmri_spec.mask = {''};
matlabbatch{9}.spm.stats.fmri_spec.cvi = 'AR(1)';
matlabbatch{10}.spm.stats.review.spmmat(1) = cfg_dep('fMRI model specification: SPM.mat File', substruct('.','val', '{}',{9}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','spmmat'));
matlabbatch{10}.spm.stats.review.display.matrix = 1;
matlabbatch{10}.spm.stats.review.print = 'ps';
matlabbatch{11}.spm.stats.fmri_est.spmmat(1) = cfg_dep('fMRI model specification: SPM.mat File', substruct('.','val', '{}',{9}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','spmmat'));
